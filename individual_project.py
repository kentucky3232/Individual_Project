# -*- coding: utf-8 -*-
"""
Created on Tue Nov 15 15:31:02 2022
...
# print((31+28+20)*24+(11+30+31+21)*24)
# print((31+28+20)*24+(11+30+31+21)*24+168)
...
df = pd.DataFrame({"net heat" : net_heat_demand,
                    
                   "space heating" : sh_demand_retrofit,
                   "hot water" : hw_demand})
...
#heat pump calculations (based off Staffel et al)
flow_temp = 45
...
pv_elec = pv_elec * 410
wind_elec = wind_elec * 2000
pv_elec_sum = pv_elec.sum()
wind_elec_sum = wind_elec.sum()
net_elec_gen = pv_elec + wind_elec
storage = 5000
storage1 = 0

print(wind_elec.sum())

# df = pd.DataFrame({"pv" : pv_elec,
#                    "wind": wind_elec})
# graph_sum(df)
